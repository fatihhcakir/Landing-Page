    ...
    return (
        <div className="relative flex flex-1">
            <div className="flex-1 ml-20">
                <h1 className="text-5xl text-black text-left mb-8">
                ...
                <div className="flex items-left justify-left space-x-4 mt-12">
                    <Buttons
            ...
            <div className="flex-1 items-center justify-center p-6 mb-10">
